...
from web.service import index_pe_service
from web.biz import index_pe_analyzer


index_pe_blueprint = Blueprint('index_pe', __name__, url_prefix='/index_pe')


@index_pe_blueprint.route('/view')
def view():
    return render_template("index_pe/view.html")


@index_pe_blueprint.route('/chart_json')
def info():
    # 上证pe
...
@index_pe_blueprint.route('/download')
def download():
