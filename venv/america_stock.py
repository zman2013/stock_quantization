...
def analyse( index_df ):
    ...
    for index in range(len(index_df)-80, 0, -1):
        data = index_df.iloc[index]

        index_check_result = check_point( index, index_df)
...
index_df['zichan'] = index_df['zichan'] / 10000
